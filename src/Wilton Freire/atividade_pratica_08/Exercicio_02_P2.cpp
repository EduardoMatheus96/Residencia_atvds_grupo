...
int main(void)
{
    ...
    for (int i = 0; i < 10; i++)
    {
        cout << "Na unidade meteorologica: " << i + 1 << " // O valor da temperatura e: " << temperaturas[i] << endl;
    }
    ...
    cout << "O valor medio e: " << somaTemp / 250 << endl;
    cout << "O menor valor e: " << minContagem << endl;
    cout << "O maior valor e: " << maxContagem << endl;
