/*
    O programa deve listar os estudantes com suas respectivas notas e médias, 
    indicando para cada aluno se está aprovado (média >= 7) ou reprovado (média < 7) e 
    permitir a mudança de alguma nota. 
        O programa deve perguntar: "Deseja alterar alguma nota (s/n)?" 
        E proceder de acordo, solicitando o nome do aluno cuja nota vai ser alterada. 
        Localizado o aluno (o programa deve informar se não conseguiu localizá-lo), o 
        programa mostra suas notas e pergunta: "Alterar a primeira nota (1), a 
        segunda nota (2) ou nenhuma (0)?" 
        E proceder de acordo, alterando a nota que foi solicitada. 
        Esta pergunta deve ser repetida (e alguma nota possivelmente alterada) até 
        que a resposta seja 0 (nenhuma nota). 
        O programa, então deve voltar ao começo da etapa e repetir tudo até que o 
        usuário responda que não deseja alterar nenhuma nota.
